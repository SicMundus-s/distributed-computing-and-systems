package itmo.org.learningenglishmanagmentsystem.rabbitmq.config;
...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue queueSecurity() {
        return new Queue("queueSecurity", true);
    }

    @Bean
    public Queue queueEnglishData() {
        return new Queue("queueEnglishData", true);
    }
}
